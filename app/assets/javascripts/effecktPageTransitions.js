...
var EffecktPageTransitions = {
  ...
  animationEndEventName: function() {EffecktPageTransitions.animationEndEventNames[Modernizr.prefixed('animation')]},
  transitionEndEventName: function() {EffecktPageTransitions.transitionEndEventNames[Modernizr.prefixed('transition')]},
  ...
  transitionPage: function( transitionPage, transitionInEffect, transitionOutEffect ) {
    ...
    var evt = this.animationEndEventName + ' ' + this.transitionEndEventName,
        self= this;
...
TA.PageTransitions = EffecktPageTransitions;