...
class ProgressesControllerTest < ActionController::TestCase
  ...
  test "should create progress" do
    assert_difference('Progress.count') do
      post :create, progress: { couple_id: @progress.couple_id, finished: @progress.finished, kind: @progress.kind, start_class: @progress.start_class, start_placings: @progress.start_placings, start_points: @progress.start_points }
    end
  ...
  test "should update progress" do
    put :update, id: @progress, progress: { couple_id: @progress.couple_id, finished: @progress.finished, kind: @progress.kind, start_class: @progress.start_class, start_placings: @progress.start_placings, start_points: @progress.start_points }
    assert_redirected_to progress_path(assigns(:progress))
  end
